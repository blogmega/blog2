...
// Ambil ID dari URL, misalnya /contentDetails/tv-online
let id = location.pathname.split('/').pop(); // Mengambil bagian terakhir dari URL
console.log("ID:", id);
...
httpRequest.onreadystatechange = function () {
    if (this.readyState === 4 && this.status == 200) {
        ...
        // Mencari produk berdasarkan ID yang bisa berupa string
